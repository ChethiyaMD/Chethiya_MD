...
*│◈ AUTO_STICKER:* .update AUTO_STICKER: tru*│◈ AUTO_REPLY:* .update AUTO_REPLY: true
...
let buttons = [{
    ...
    let message = {
                    image: LOGO,
                    header: '*➳ᴹᴿ᭄亗*Chethiya* ╰‿╯穴༺*==>》MD Setting',
                    footer: FOOTER,
                    body: setting
...
let repo =`
*╭──────────────●●►*
*| BOT_NUMBER :>* 072484047
*| OWNER=NUMBER:* 94702484047 
*| Chethiya_MD-REPO :*https://github.com/ChethiyaMD/Chethiya_MD*
*╰──────────────●●►*
`
const ownerdata = (await axios.get('https://raw.githubusercontent.com/athulakumara604/ASITHA-MD-DATABASE/refs/heads/main/ditels/ditels.json')).data
            let LOGO = ownerdata.imageurl;
